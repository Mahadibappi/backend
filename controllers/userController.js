...
const forgotPassword = asyncHandler(async (req, res) => {
    ...
    // delete token if is already exist in DB
    ...
    // hashed token before save to DB
    ...
    // <p>Inventory Team</p>
    // `;
    // const subject = "Rest password Request";
    // const send_to = "mahadibappe29551@gmail.com";
    ...
    // } catch (error) {
    //     res.status(500);
    //     throw new Error("Email not sent, please again");
